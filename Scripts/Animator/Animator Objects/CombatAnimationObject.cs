...
[CreateAssetMenu(fileName = "AnimationObject", menuName = "AnimationCards/Combat")]
public class CombatAnimationObject : ScriptableObject
{
    ...
    public List<ClipTransition> AnimClips = new List<ClipTransition>();
    ...
    public bool ISFLYING
    {
        get
        {
            ...
            else if (IsFlying == Options.OR)
            {
                isFlying = FindObjectOfType<InputController>().isFlying;
            }
            return isFlying;
        }
        set
    ...
    public bool ISSECONDARYATTACK
    {
        get
        {
            if (IsSecondaryAttack == Options.YES)
            {
                isSecondaryAttack = true;

            }
            else if (IsSecondaryAttack == Options.NO)
            {
                isSecondaryAttack = false;
            }
            else if(IsSecondaryAttack == Options.OR)
            {
                isSecondaryAttack = FindObjectOfType<InputController>().isSecondaryAttack;
            }
            else
            {
                isSecondaryAttack = false;
    ...
    public bool ISSHEATING
    {
        get
        {
            if (IsSheating == Options.YES)
            {
                isSheating = true;

            }
            else if (IsSheating == Options.NO)
            {
                isSheating = false;
            }
            else
    ...
    public string WEAPONTYPE 
    {
        get
        {
            if(WeaponType == Weapons.Fists)
            {
                weaponType = "Fists";
            }
            else if (WeaponType == Weapons.SingleHandedSword)
            {
            ...
            else if ((WeaponType == Weapons.FireBall))
            {
                weaponType = "FireBall";
            }
            else if (WeaponType == Weapons.DragonHandMelee)
            {
                weaponType = "DragonHandMelee"; 
            }
            else if (WeaponType == Weapons.None)
            {
                weaponType = FindObjectOfType<CombatController>().weaponType;
            }
            return weaponType;
        }
        set
    ...
    public string PRIMARYTAPS
    {
        get
        {
            if (PrimaryTaps ==  Taps.Single)
            {
                primaryTaps = "Single";
            }
            else if (PrimaryTaps == Taps.Double)
            {
                primaryTaps = "Double";
            }
            else if (PrimaryTaps == Taps.Triple)
            {
                primaryTaps = "Triple";
            }
            ...
            {
                //primaryTaps = "None";
                primaryTaps = FindObjectOfType<HumanoidCombatController>().clicks;
            }
